  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(children: [
        ...
        CustomPaint(
          size: Size(w / 1.7,
              (h / 2.45).toDouble()), //You can Replace [WIDTH] with your desired width for Custom Paint and height will be calculated automatically
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(image: AssetImage('assets/unnamed.jpg'), fit: BoxFit.cover),
                ),
              ),
              Text(
                "Easy Appointments",
              ...
              Padding(
                ...
                child: Text(
                  "We introduce the most easiest appointment\nbooking system",
